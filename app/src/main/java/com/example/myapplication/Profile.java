...
public class Profile extends AppCompatActivity {
    ...
    private Custom1Adapter customAdapter1;
    Button camera_bt;
    Button gallery_bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simpleList1=findViewById(R.id.simpleListView);
        camera_bt=findViewById(R.id.camera_bt);
        ...
        plantList=new ArrayList<>();
                ...
                customAdapter1=new Custom1Adapter(Profile.this,plantList);
       camera_bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Profile.this, SetThresholds.class);
    ...
    protected void onStart() {
        ...
        lastQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                simpleList1.setAdapter(customAdapter1);
            }
    ...
    public void uploadImageToFirebase(String name,Uri contentUri)
    {
        ...
        image.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                Toast.makeText(Profile.this,"upload is uploaded",Toast.LENGTH_SHORT).show();
            }
