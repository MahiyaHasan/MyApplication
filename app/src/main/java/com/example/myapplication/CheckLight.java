...
Button startReading_bt,stopReading_bt,turnFlaslightsOn_bt;
TextView light_tv;
...
DatabaseReference reff;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        turnFlaslightsOn_bt = findViewById(R.id.turnFlaslightsOn_bt);
        startReading_bt = findViewById(R.id.startReading_bt);
        stopReading_bt = findViewById(R.id.stopReading_bt);
        ...
        startReading_bt.setOnClickListener(new View.OnClickListener() {
            ///////////////////////////###################
            @Override
...
//  moisture_tv.setText(moistureValueInt);
        ...
        turnFlaslightsOn_bt.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                reff.child("TurnLightOn").setValue("1");

                Intent intent = new Intent(getApplicationContext(), SetTimer.class);
        ...
        stopReading_bt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                reff = FirebaseDatabase.getInstance().getReference();
